...
## [0.44.0](https://github.com/william0wang/zcode-acp/compare/v0.43.3...v0.44.0) (2026-09-18)
...
* add /quota slash command for GLM Coding Plan usage display ([#10](https://github.com/william0wang/zcode-acp/issues/10)) ([afd8f80](https://github.com/william0wang/zcode-acp/commit/afd8f80283d2728e1cc48930e55d28d2b23ea671))
* add configOptions, runtimeModel overlay, model cache, and set_config_option ([b17f898](https://github.com/william0wang/zcode-acp/commit/b17f8980dfb94b10502e4a3d9f2c97cacb2ea841))
* add elicitation form path, deferred available-commands, and English docs ([542d585](https://github.com/william0wang/zcode-acp/commit/542d5853e6156addfb468a24c0125c84da5b8daf))
* add event translators and dispatch with full turn loop ([831a25c](https://github.com/william0wang/zcode-acp/commit/831a25cd587d7bf6a4cfb9b657b87075b9b73ec8))
* add heat-colored progress bars with in-bar overlay to zcode-quota  ([#40](https://github.com/william0wang/zcode-acp/issues/40)) ([a5cb8a1](https://github.com/william0wang/zcode-acp/commit/a5cb8a1ae8201fd2c9fcc51ebffebf4e343e8391))
* add input hint to skills with argument-hint frontmatter ([#19](https://github.com/william0wang/zcode-acp/issues/19)) ([3b15e2f](https://github.com/william0wang/zcode-acp/commit/3b15e2fc4fc429616a5a8ab0df4f794461d5b278))
* add interaction channel with requestPermission, ExitPlanMode, and AskUserQuestion multi-select ([2652e42](https://github.com/william0wang/zcode-acp/commit/2652e42847afb331b49f0d1f086d5973bf9723e5))
...
* add session lifecycle handlers and wire backend into ACP server ([9074f88](https://github.com/william0wang/zcode-acp/commit/9074f88cf45336f2edc82cf71213952098bc274b))
* add standalone zcode-quota CLI with watch mode ([#13](https://github.com/william0wang/zcode-acp/issues/13)) ([a371f51](https://github.com/william0wang/zcode-acp/commit/a371f51a6041c7567afba53f35c9edbd324dfaa4))
* add tasks-index sync, session title dedup, and graceful shutdown ([e0bd2c1](https://github.com/william0wang/zcode-acp/commit/e0bd2c184b5ae1aa0e8f33e7cfd4ba6fa18437c1))
* add zcode backend client with subprocess, reader-loop routing, and event listener ([af6f54b](https://github.com/william0wang/zcode-acp/commit/af6f54b261a94e29af7fc433679c45696d394629))
* add ZCode session extensions and slash command interception ([bb506bf](https://github.com/william0wang/zcode-acp/commit/bb506bf1b13dda6af73eb782d160b1d5aff3c770))
...
* advertise authMethods for ACP registry compatibility ([#8](https://github.com/william0wang/zcode-acp/issues/8)) ([453ee8d](https://github.com/william0wang/zcode-acp/commit/453ee8de4b96ff247025496656b983381c4c5a15))
* auto-compact context when token usage exceeds ENV threshold ([#17](https://github.com/william0wang/zcode-acp/issues/17)) ([2408a9a](https://github.com/william0wang/zcode-acp/commit/2408a9a6c3e90bbc0974b8f5fa96b7c77f299332))
* badge background Bash tasks by reusing the launch card ([#23](https://github.com/william0wang/zcode-acp/issues/23)) ([69b0c54](https://github.com/william0wang/zcode-acp/commit/69b0c54f7ca18fddc6ea21e146c29f3f62b8ed09))
* bilingual user strings with ZCODE_ACP_LANG and app locale inheritance (0.16.0) ([#89](https://github.com/william0wang/zcode-acp/issues/89)) ([930a6f2](https://github.com/william0wang/zcode-acp/commit/930a6f2efb79d0aaeb08c18966146f7dcb9d9e24))
...
* collapsed context handoff summaries in replay (0.4.0) ([#53](https://github.com/william0wang/zcode-acp/issues/53)) ([b7a1b46](https://github.com/william0wang/zcode-acp/commit/b7a1b46cd98a7bc0f40abec0c67fb11fafaa88f9))
* dl=1 flag serves file downloads as attachment ([#74](https://github.com/william0wang/zcode-acp/issues/74)) ([056a695](https://github.com/william0wang/zcode-acp/commit/056a695461df5ea1d792e0a5d7190f947fa5e63c))
...
* expose turn state via replayMeta.turnActive and $zcode/turnState ([d5d866f](https://github.com/william0wang/zcode-acp/commit/d5d866fae0e1d02e36ebd92fa6170c74784dd82a))
* expose ZCode skill/init/plugin commands and friendly-error TUI-only commands ([#18](https://github.com/william0wang/zcode-acp/issues/18)) ([0fde59a](https://github.com/william0wang/zcode-acp/commit/0fde59a51acf0d3eb9803343e79b8dcbb7bd2ce4))
* gate verbose logs behind ZCODE_ACP_DEBUG (quiet by default) ([#6](https://github.com/william0wang/zcode-acp/issues/6)) ([ace1353](https://github.com/william0wang/zcode-acp/commit/ace13532aa63e1419723080c168c04af40818a12))
...
* HTTP quota and session-status endpoints for remote clients ([#59](https://github.com/william0wang/zcode-acp/issues/59)) ([8b113bf](https://github.com/william0wang/zcode-acp/commit/8b113bf04ae82b79e7f841a107fd67ae879b4764))
* hub self-decided upgrade check via POST /api/upgrade ([#73](https://github.com/william0wang/zcode-acp/issues/73)) ([6b613a4](https://github.com/william0wang/zcode-acp/commit/6b613a41bb65d6ebd5e800c39da3920f4cfa7b0f))
* implement Bash terminal protocol with 2-notification split and differ sync ([5a133a0](https://github.com/william0wang/zcode-acp/commit/5a133a0de474f067f38850ec157cfe95f7537e9b))
* interactive Ink REPL as bare zcode-acp default (ADR-0007) ([#76](https://github.com/william0wang/zcode-acp/issues/76)) ([d60d077](https://github.com/william0wang/zcode-acp/commit/d60d077e04426e8539e71dd67413eec92446ab44))
* interactive REPL for bare zcode-acp (native-scrollback Ink UI) ([fcb755e](https://github.com/william0wang/zcode-acp/commit/fcb755e50e23f06062c0e63a24cc6501f00d2dda))
* name byte-path file downloads via Content-Disposition ([#72](https://github.com/william0wang/zcode-acp/issues/72)) ([85d8c42](https://github.com/william0wang/zcode-acp/commit/85d8c42fe5d8f330211bdc9746001cce90f5fcf0))
...
* one-shot session titles with remote rename endpoint ([#75](https://github.com/william0wang/zcode-acp/issues/75)) ([cc406de](https://github.com/william0wang/zcode-acp/commit/cc406dedc857b14472ec24cf436d006deeed42a6))
* opt-in macOS Seatbelt sandbox confining agent writes (ADR-0011) ([#88](https://github.com/william0wang/zcode-acp/issues/88)) ([36cab40](https://github.com/william0wang/zcode-acp/commit/36cab40758832ad88cdc0b0d1b6e69fdd946d61a))
* pass dragged images to backend as session/send attachments ([#26](https://github.com/william0wang/zcode-acp/issues/26)) ([30e9abe](https://github.com/william0wang/zcode-acp/commit/30e9abefc53c6802f75c4361ee8bd059d065a69e))
...
* re-send undecided interaction requests to reconnected remote clients ([#64](https://github.com/william0wang/zcode-acp/issues/64)) ([7342c68](https://github.com/william0wang/zcode-acp/commit/7342c68032bfa77b95b97cbc39eeb2faf2e4f1fe))
...
* remote access for mobile clients via zcode-acp-hub ([#49](https://github.com/william0wang/zcode-acp/issues/49)) ([59c5bbb](https://github.com/william0wang/zcode-acp/commit/59c5bbb02606ec5a507fe9fb5bc193bd197a0497))
* remote file access, running-scoped discovery, replay collapse, release 0.7.0 ([#56](https://github.com/william0wang/zcode-acp/issues/56)) ([c0cea08](https://github.com/william0wang/zcode-acp/commit/c0cea0877bfe55dad23ed437cae82ef8fa4e6f3d))
* remote session close, release 0.9.0 ([#61](https://github.com/william0wang/zcode-acp/issues/61)) ([f1f8b7c](https://github.com/william0wang/zcode-acp/commit/f1f8b7c595236ffea9eba7916fab436196b1db1a))
...
* REPL prompt history, paste newline folding, and /new session swap ([#84](https://github.com/william0wang/zcode-acp/issues/84)) ([4a408f0](https://github.com/william0wang/zcode-acp/commit/4a408f03475ce2283abd3a14c8e9dff390a4b909))
* revamp elicitation forms for free-text input ([#30](https://github.com/william0wang/zcode-acp/issues/30)) ([4b3b15e](https://github.com/william0wang/zcode-acp/commit/4b3b15e8ed8fa592cf4526e751b0362e438583b8))
* scaffold zcode-acp-server with stdio ACP wiring and initialize handler ([501a71f](https://github.com/william0wang/zcode-acp/commit/501a71ff472880cad54cceab301d244a2ac66652))
...
* support custom model providers and fix model switching for new backend ([#27](https://github.com/william0wang/zcode-acp/issues/27)) ([1b941c8](https://github.com/william0wang/zcode-acp/commit/1b941c8ae5e35dc8fa8f7ad7f0169f287ec734f9))
* sync sub-agent and background task events to ACP client ([#21](https://github.com/william0wang/zcode-acp/issues/21)) ([b18487e](https://github.com/william0wang/zcode-acp/commit/b18487e56260480be7a37d35a5bf0dc5010dab8a))
...
* abort AskUserQuestion popup loop on turn cancel or timeout ([#22](https://github.com/william0wang/zcode-acp/issues/22)) ([2d2aee1](https://github.com/william0wang/zcode-acp/commit/2d2aee1d9d62698382fac16f005add0ce83c3c8e))
...
* advertise new sessions at first turn start, not after it completes ([#57](https://github.com/william0wang/zcode-acp/issues/57)) ([7e6b0d7](https://github.com/william0wang/zcode-acp/commit/7e6b0d7e9d465ce7faa31fd285b2c32f9f9371f4))
...
* always replay the current todo list on session/load ([#71](https://github.com/william0wang/zcode-acp/issues/71)) ([d998268](https://github.com/william0wang/zcode-acp/commit/d9982689b2749f80c1e725c57d04c57308bad76f))
...
* architecture review quick wins (settle-once, hub, config lookup, turn-idle grace) ([#66](https://github.com/william0wang/zcode-acp/issues/66)) ([6a3e81f](https://github.com/william0wang/zcode-acp/commit/6a3e81f0da7eb8a7dd34486e4ad2eac7119d93b7))
...
* bound stale running turn recovery (rebased) ([#85](https://github.com/william0wang/zcode-acp/issues/85)) ([4179870](https://github.com/william0wang/zcode-acp/commit/41798705b7ae86d0380766a6d386436cec5b6e74))
...
* cancel session and binary drag-drop ([#39](https://github.com/william0wang/zcode-acp/issues/39)) ([a8ab2e3](https://github.com/william0wang/zcode-acp/commit/a8ab2e386d03ef8caea5d6205c42abdd3200a386))
* cancel-then-send hang, turn contamination, abort storm, and thought-level root cause ([#48](https://github.com/william0wang/zcode-acp/issues/48)) ([561f4f5](https://github.com/william0wang/zcode-acp/commit/561f4f5a148327a3a5ff9936dd0b5317864b2a90))
...
* compact/goal lock-wait unit bug + backend stdin error handling ([#4](https://github.com/william0wang/zcode-acp/issues/4)) ([44d685e](https://github.com/william0wang/zcode-acp/commit/44d685e945c77953de7ecf404fbf4527b65280ee))
* create tool cards when scheduled events are missing ([#82](https://github.com/william0wang/zcode-acp/issues/82)) ([a6420bd](https://github.com/william0wang/zcode-acp/commit/a6420bd57ac3cba8eb46c6965689604f77532988))
...
* derive the pending-session current model from the enabled provider ([#47](https://github.com/william0wang/zcode-acp/issues/47)) ([2e364dd](https://github.com/william0wang/zcode-acp/commit/2e364dd7f9cca23cd79b6d7cdf05dce8ec41971b))
...
* empty locale preference, BOM settings, zh-machine test pins (0.16.2) ([#91](https://github.com/william0wang/zcode-acp/issues/91)) ([36570c6](https://github.com/william0wang/zcode-acp/commit/36570c6f08db49dde1090d7ddb2994dde7ec971e))
* flatten todoGroups list and make interaction requests cancel-aware ([0582d87](https://github.com/william0wang/zcode-acp/commit/0582d87b6220425c7db4cb90261970cf5924f2b8))
* forward ACP session mcpServers to the backend's session create/resume ([#43](https://github.com/william0wang/zcode-acp/issues/43)) ([767224c](https://github.com/william0wang/zcode-acp/commit/767224cff1234e8e81d67c584d172f7a48fa2356))
...
* harden slash-command push and tasks-index sync against transient failures ([#25](https://github.com/william0wang/zcode-acp/issues/25)) ([7339fad](https://github.com/william0wang/zcode-acp/commit/7339fadd9edc0bb7c34a03eed9771031b5503b6e))
* heartbeat-probe session availability, release 0.5.1 ([#55](https://github.com/william0wang/zcode-acp/issues/55)) ([a04e360](https://github.com/william0wang/zcode-acp/commit/a04e360a91e61d12d41d606d5c62a7edd153bf32))
...
* i18n cross-review follow-ups (startup crash, cache bust, coverage gaps) (0.16.1) ([#90](https://github.com/william0wang/zcode-acp/issues/90)) ([13f37da](https://github.com/william0wang/zcode-acp/commit/13f37dae0aa2ff38e1e7d7014a1c5b874b85f8e0))
...
* key stall termination on read watermark, not prompt lock (0.14.3) ([#86](https://github.com/william0wang/zcode-acp/issues/86)) ([ca7a739](https://github.com/william0wang/zcode-acp/commit/ca7a739c671e5075db4fd4ff1e5c3609c2de3596))
* make session file roots backend-authoritative, never trust client cwd ([#70](https://github.com/william0wang/zcode-acp/issues/70)) ([d42485c](https://github.com/william0wang/zcode-acp/commit/d42485c2f7bf03b9b9622aff0bdba78a939683f7))
...
* mode UI update on slash command and prompt-lock leak on stop ([32b5a34](https://github.com/william0wang/zcode-acp/commit/32b5a344d4a74efc674057b959fc630aa6391c10))
* normalize permission option kind and recognize all allow optionIds ([#5](https://github.com/william0wang/zcode-acp/issues/5)) ([5f178a6](https://github.com/william0wang/zcode-acp/commit/5f178a6543cfeddc1f77a1d04ee6247ce9d304dc))
...
* plan todos re-check after async backend write, release 0.11.2 ([#68](https://github.com/william0wang/zcode-acp/issues/68)) ([449e59d](https://github.com/william0wang/zcode-acp/commit/449e59d264969ee39d5f32a1c69d7353db2e8792))
* pollEvent zombie waiter, async close reap, turn cancel reference, differ.diff at completion, Edit/Write diff dispatch, stable signatures ([dc2e1b3](https://github.com/william0wang/zcode-acp/commit/dc2e1b37d1d727703ad5b921fae317177fd87ced))
* preempt in-flight turn when a new prompt arrives without cancel ([#2](https://github.com/william0wang/zcode-acp/issues/2)) ([ecf30a4](https://github.com/william0wang/zcode-acp/commit/ecf30a4a8d669d461a3edb3faca9e7cfb8a43fac))
...
* preserve structured quota failures over acp ([#78](https://github.com/william0wang/zcode-acp/issues/78)) ([e053b97](https://github.com/william0wang/zcode-acp/commit/e053b979df70bd20ba535b01aea6904ec4c08dc9))
...
* push TODO list updates on tool completion instead of waiting ([#20](https://github.com/william0wang/zcode-acp/issues/20)) ([4c068b7](https://github.com/william0wang/zcode-acp/commit/4c068b70bb21fd18f401e9a08e44c409fb043bac))
* raise remote endpoint test timeouts to survive parallel-suite load ([0079694](https://github.com/william0wang/zcode-acp/commit/0079694f9af4fd9207cb363335f629f5bca6f471))
...
* reannounce sendReply, stdin/backend shutdown triggers, thought metadata, config response, usage fallback ([c65560c](https://github.com/william0wang/zcode-acp/commit/c65560c16312117b8d5c36c047b7a7557e861932))
* reconcile session mode immediately for PlanMode ([#32](https://github.com/william0wang/zcode-acp/issues/32)) ([7182764](https://github.com/william0wang/zcode-acp/commit/7182764609c8d5dcdd9176aa3a7e65d009ba5626))
...
* remote session discovery gating and empty replay on remote open (0.3.1) ([#51](https://github.com/william0wang/zcode-acp/issues/51)) ([fecc9fc](https://github.com/william0wang/zcode-acp/commit/fecc9fcd11d5da8270ac9b208e4a5592cc4cdca3))
...
* resume initial usage, elicit toolCallId/skip, interaction timeout ([024ef0c](https://github.com/william0wang/zcode-acp/commit/024ef0cfb1bcaba3ef94a365c46b6ba1a12dbd34))
* retry session/resume to absorb backend cold-start window ([#28](https://github.com/william0wang/zcode-acp/issues/28)) ([0dd3bfa](https://github.com/william0wang/zcode-acp/commit/0dd3bfae0d16e80c8c8de7924c8a83c53cb5ffa2))
* retry session/resume to absorb backend cold-start window ([#29](https://github.com/william0wang/zcode-acp/issues/29)) ([2533a1b](https://github.com/william0wang/zcode-acp/commit/2533a1ba3edc31cad71e3a4bd4105a3575436453))
* retry transient turn.failed and degrade gracefully instead of ([#33](https://github.com/william0wang/zcode-acp/issues/33)) ([930b69f](https://github.com/william0wang/zcode-acp/commit/930b69f92c315a64ee843741dd3aa963982c09de))
* route /goal through extensions.ts and sync /model UI after switch ([#36](https://github.com/william0wang/zcode-acp/issues/36)) ([c58f927](https://github.com/william0wang/zcode-acp/commit/c58f9277ed2440dc52815c4bcf48e92db2df7aad))
* route ExitPlanMode through request_permission instead of ([#31](https://github.com/william0wang/zcode-acp/issues/31)) ([2afe5df](https://github.com/william0wang/zcode-acp/commit/2afe5df4a2e95b1abe4417a6f403722e18c2a97a))
* route server→client requests by sessionId to prevent cross-session popup leaks ([#12](https://github.com/william0wang/zcode-acp/issues/12)) ([174614f](https://github.com/william0wang/zcode-acp/commit/174614f4d81a11ced9b909fd1d9e7815f861a100))
* route the spec-spelled session/set_mode request ([#46](https://github.com/william0wang/zcode-acp/issues/46)) ([15fda81](https://github.com/william0wang/zcode-acp/commit/15fda818ee571531a4481163893ace17615cf63a))
...
* self-heal sessions evicted from the backend (Session is not active -32004) ([#69](https://github.com/william0wang/zcode-acp/issues/69)) ([a801996](https://github.com/william0wang/zcode-acp/commit/a8019962ee02b66b6e4b658524007488bb238bca))
* send only stdout delta in Bash terminal output to prevent replay ([#14](https://github.com/william0wang/zcode-acp/issues/14)) ([e0b4695](https://github.com/william0wang/zcode-acp/commit/e0b469509b816bbd3e580dc817b365a94d4a773a))
* send only stdout delta in Bash terminal output to prevent replay ([#15](https://github.com/william0wang/zcode-acp/issues/15)) ([2bb43cf](https://github.com/william0wang/zcode-acp/commit/2bb43cf8357044dc222501539d17dc7acc02b69b))
...
* stabilize session/create flow — runtime-prefs handshake, third-party providers, lazy sessions, model state ([#38](https://github.com/william0wang/zcode-acp/issues/38)) ([17e9fc6](https://github.com/william0wang/zcode-acp/commit/17e9fc6a993c5575d46edc0efb116cc4fcd4ae81))
* stop dropping dragged-file attachments in session/prompt ([#24](https://github.com/william0wang/zcode-acp/issues/24)) ([53d85a1](https://github.com/william0wang/zcode-acp/commit/53d85a11c8d863a8e658aa2cadbf513bcf11d3d0))
* stop pushing output to UI after session/cancel ([#37](https://github.com/william0wang/zcode-acp/issues/37)) ([d140db6](https://github.com/william0wang/zcode-acp/commit/d140db6bf8b3293f721519ba2840e5aac15d3a91))
* stop/cancel/preempt robustness aligned with Python reference + docs ([#3](https://github.com/william0wang/zcode-acp/issues/3)) ([3cec5e1](https://github.com/william0wang/zcode-acp/commit/3cec5e194425eff6cb54e6cd0097f762d752cd26))
* strip tagless reminders and dedupe replay history (0.3.2) ([#52](https://github.com/william0wang/zcode-acp/issues/52)) ([8242518](https://github.com/william0wang/zcode-acp/commit/8242518e06140ba11f0aec152761d1d1d7c3de21))
...
* sync meta_json.title in updateSessionTitle so ZCode App shows it ([#16](https://github.com/william0wang/zcode-acp/issues/16)) ([04e7ac5](https://github.com/william0wang/zcode-acp/commit/04e7ac5af9e297757faf9391b4bef3573336525d))
* sync tasks-index format and 3.3.0 protocol for ZCode App session ([#11](https://github.com/william0wang/zcode-acp/issues/11)) ([7f7fc38](https://github.com/william0wang/zcode-acp/commit/7f7fc38570c656c1418343607f53e0ac07451b12))
...
* wait indefinitely for user confirmation instead of auto-declining ([#35](https://github.com/william0wang/zcode-acp/issues/35)) ([5c0f894](https://github.com/william0wang/zcode-acp/commit/5c0f89472e935e96f3e2a6a61f1d049c7fab7ef5))
